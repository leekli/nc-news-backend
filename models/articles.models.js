...
exports.fetchArticles = (topic, author, search, sort_by = 'created_at', order = 'DESC') => {
  ...
  let queryStr = 'SELECT articles.author, articles.title, articles.article_id, articles.topic, articles.created_at, articles.votes, COUNT(comment_id) AS comment_count FROM articles LEFT JOIN comments ON comments.article_id = articles.article_id';
...
exports.fetchArticleById = (article_id) => db
  .query(
...
exports.removeArticle = (article_id) => db
